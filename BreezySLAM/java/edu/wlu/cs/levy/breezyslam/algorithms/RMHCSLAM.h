...
#define edu_wlu_cs_levy_breezyslam_algorithms_RMHCSLAM_DEFAULT_SIGMA_XY_MM 100.0
#undef edu_wlu_cs_levy_breezyslam_algorithms_RMHCSLAM_DEFAULT_SIGMA_THETA_DEGREES
#define edu_wlu_cs_levy_breezyslam_algorithms_RMHCSLAM_DEFAULT_SIGMA_THETA_DEGREES 20.0
